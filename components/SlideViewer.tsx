...
const SlideViewer: React.FC<SlideViewerProps> = ({ slides }) => {
  ...
  if (!slides || slides.length === 0) return <div className="text-center py-20 text-slate-400 italic">No slides generated. Click "Generate Materials" to begin.</div>;
    ...
    <div className="space-y-4">
      <div className="relative bg-slate-800 rounded-xl overflow-hidden shadow-2xl aspect-[16/9] flex flex-col border-4 border-slate-900">
        <div className="bg-slate-900 px-6 py-3 flex justify-between items-center border-b border-slate-700">
          ...
          <span className="text-[10px] font-bold text-slate-500 tracking-widest uppercase">Army CourseForge v2.0</span>
        </div>
        ...
        <div className="bg-slate-900 px-6 py-2 flex justify-between items-center border-t border-slate-700 text-[10px] font-bold text-slate-500">
          ...
          <span className="uppercase tracking-widest">Unclassified // Verified Doctrinal Source Use</span>
        </div>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-lg overflow-hidden">
        ...
        >
          <span className="flex items-center gap-2">
            <span className="text-lg">📋</span> Instructor Briefing Notes & Citations
          </span>
